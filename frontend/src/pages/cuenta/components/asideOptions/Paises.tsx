...
export default function Paises() {
  ...
  return (
    <div className="min-h-110 w-full border-1 border-gray-200 shadow-md bg-white/50 rounded-2xl py-10 px-12">
      <div className="h-full flex flex-col">
        <div className="w-full flex items-center justify-between">
          <div className="flex items-center space-x-4">
            <h2 className="text-3xl font-bold text-gray-800">Países</h2>
            <a href="#" className="secondary-button w-10 h-10 flex items-center justify-center">
