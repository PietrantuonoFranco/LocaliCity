...
export default function ProfileData () {
  ...
  return (
    <>
      {!user && (
        <div class="hidden lg:flex items-center justify-end space-x-4 text-xs">
          <div class="flex flex-col items-end justify-center space-y-0.5">
            <a href="/registrarse" class="text-gray-600 flex items-center space-x-2 py-1 px-2 hover:text-gray-800 hover:rounded-md hover:bg-gray-100 duration-300 transition-all">
            ...
            <a href="/iniciar-sesion" class="text-gray-600 flex items-center space-x-1 py-1 px-2 hover:text-gray-800 hover:rounded-md hover:bg-gray-100 duration-300 transition-all">
              <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4" viewBox="0 0 24 24">
